(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, 'iclient-openlayers')) {
          if (supportES6()) {
              inputScript(path+"/supermap/js/iclient-openlayers-es6.min.js");
          } else {
              inputScript(path+"/supermap/js/iclient-openlayers.min.js");
          }
        }
        if (!inArray(excludes, 'iclient-openlayers-css')) {
            inputCSS(path+"/supermap/css/iclient-openlayers.min.css");
        }
    }
