...
*/
    ...
    (function (a) {
        ...
        f.prototype = {
            all: function () {
                ...
                for (var d = [], e, f, g, h; b;) {
                    e = 0;
                    for (f = b.children.length; e < f; e++) if (g = b.children[e],
                        h = b.fb ? c(g) : g, u(a, h)) {
            ...
            rh: function (a, b) {
                ...
                e.children.push(a);
                for (l(e, c); 0 <= b;) if (d[b].children.length > this.Lf) this.Dk(d,
                    b), b--; else break;
                this.uk(c, d, b)
            }, Dk: function (a, b) {
    ...
    k.wa = function (a, b, c, d, e, f, g) {
        ...
        d = Math.round(d);
        var l = 2 * d + 1, m = ef(this.j, d + .5, d + .5, 1 / b, -1 / b, -c, -a[0], -a[1]), n = this.f;
