...
(function () {
    ...
    function load() {
        ...
        inputScript(path+"/supermap/js/tokengenerator.js");
        ...
        if (!inArray(excludes, 'example-i18n')) {
            ...
            inputScript(path+"/supermap/js/utils.js");
            inputScript(path+"/supermap/js/localization.js");
        ...
        if (inArray(includes, 'widgets.alert')) {
            inputScript(path+"/supermap/js/widgets.js");
        }
